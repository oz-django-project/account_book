...
from accounts.models import TransactionHistory, Account
...
class WeeklyDailyAnalysisTestCase(TestCase):
    def setUp(self):
        ...
        self.account = Account.objects.create(
            user=self.user, account_number="1234567890", bank_code="001", account_type="CHECKING", balance=100000
        )
    ...
    def test_analyzer_creates_analysis_instance(self):
        ...
        self.assertIsInstance(result, Analysis, "반환값은 Analysis 인스턴스여야 합니다.")
